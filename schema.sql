...
INSERT INTO user VALUES(1,'test@test.com','68111a80c1afdb838f7b636e11cc9b94');
...
Create Table SiteData(
  ...
  LabourScore INTEGER  Not NUll,
  LabourCount INTEGER  Not NUll,
  ConservativeScore INTEGER Not NUll,
  ConservativeCount INTEGER  Not NUll,
  LibDemScore INTEGER Not NUll,
  LibDemCount INTEGER Not NUll
);
Insert Into SiteData VALUES("bbc",0,0,0,0,0,0);
Insert Into SiteData VALUES("dailymail",0,0,0,0,0,0);
Insert Into SiteData VALUES("independent",0,0,0,0,0,0);
Insert Into SiteData VALUES("telegraph",0,0,0,0,0,0);
Insert Into SiteData VALUES("theguardian",0,0,0,0,0,0);
...
INSERT INTO Emotions VALUES(1,'positive');
INSERT INTO Emotions VALUES(2,'negative');
INSERT INTO Emotions VALUES(3,'neutral');
create table Partys(
id INTEGER PRIMARY KEY,
  Party TEXT
);
INSERT INTO Partys VALUES(1,'Conservative');
INSERT INTO Partys VALUES(2,'Labour');
INSERT INTO Partys VALUES(3,'Liberal Democrats');
create Table PartyAfil(
  id INTEGER PRIMARY KEY,
  PartyID INTEGER NOT NULL,
  TopicID INTEGER NOT NUll,
  EmotionID INTEGER NOT NUll,
  FOREIGN KEY (PartyID)
       REFERENCES Partys (id),
  FOREIGN KEY (TopicID)
